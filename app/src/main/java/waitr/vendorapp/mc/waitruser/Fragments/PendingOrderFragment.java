...
public class PendingOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        OrderObject m1 = new OrderObject(1,1,"sid","1,2,3",new Date(2015,10,12),10,true,true);
        OrderObject m2 = new OrderObject(1,1,"sid","1,2,3",new Date(2015,10,12),10,true,true);
        OrderObject m3 = new OrderObject(1,1,"sid","1,2,3",new Date(2015,10,12),10,true,true);
        OrderObject m4 = new OrderObject(1,1,"sid","1,2,3",new Date(2015,10,12),10,true,true);
        OrderObject m5 = new OrderObject(1,1,"sid","1,2,3",new Date(2015,10,12),10,true,true);
